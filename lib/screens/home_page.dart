         ...
         //  indicatorSize: TabBarIndicatorSize.label,
           ...
           controller: tabController,
            ...
            onTap:(int index){
             ...
             homeProductBloc.fetchProduct.add(this.productsCategories[index].category_id);//هنا استخدمنا الستريم بدل السيت ستيت
      ...
      child: Column(
        ...
        children: <Widget>[
                  ...
                  itemBuilder: (context,position){
                   return Card(
                     ...
                     child: Container(
                       ...
                       child: Image(
                         fit: BoxFit.cover,//لجعل الصوره تاخذ كامل الكارد(او الوكنتينر تبعها)
          ...
          Container(
            ...
            child: Row(
              children:
                _drawDots(topProducts.length,context)
      ...
      widget.add(
        Container(
          decoration:BoxDecoration(
              ...
              color: (i==dotcurrentIndex)?ScreenUtilities.mainBlue:ScreenUtilities.lightGray
          ),
          width: 13,
          height:13,
